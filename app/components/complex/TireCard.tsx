...
export default function TireCard({ brand, model_id, model, url, type, size, img, price, tireData, offer }: TireCardProps) {
    ...
    // State to control dialog open state
        ...
        <Card className="overflow-hidden">
            ...
            <CardFooter className="p-4 pt-0 flex items-center justify-between">
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogTrigger asChild>
                        <Button onClick={() => setIsDialogOpen(true)}>Tamaños y precios</Button>
                    </DialogTrigger>
                    {dialogContent(img, model, tires, url, quantities, setQuantities, setIsDialogOpen)}
                </Dialog>
            </CardFooter>
        </Card>
    )
                ...
                <div>
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <Button size="lg" disabled={totalQuantity === 0} onClick={() => setIsDialogOpen(false)}>
                                Agregar orden
                            </Button>
                        </div>
                    </div>
